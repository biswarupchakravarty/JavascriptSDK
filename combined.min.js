var global;
(function(){global="undefined"==typeof window?process:window;global.Appacitive||(global.Appacitive={runtime:{isNode:"undefined"!=typeof process,isBrowser:"undefined"!=typeof window}});module&&module.exports&&(exports=global.Appacitive);var d=function(a){if(!a||!a.send||"function"!=typeof a.send)throw Error("No applicable httpTransport class found");a.onResponse=this.onResponse;var c=[],b={},d=0,g={},e=0;this.addProcessor=function(a){if(a){a.pre=a.pre||function(){};a.post=a.post||function(){};var c=
a.pre;d+=1;b[d]=c;a=a.post;e+=1;g[e]=a}};this.enqueueRequest=function(a){c.push(a)};this.notify=function(){if(0!==c.length){var d=[],j;for(j in g)g.hasOwnProperty(j)&&d.push(g[j]);for(;0<c.length;){var e=c.shift(),l=[];for(j in b)b.hasOwnProperty(j)&&l.push(b[j](e));a.send(e,d,l)}}};this.onResponse=function(a){console.dir(a)}},e=function(){var a=function(){throw Error("Not Implemented Exception");};this.inOnline=this.send=a;this.onResponse=function(){a()};this.onError=function(){a()}},b=function(){var a=
new e;a.type="jQuery based http provider";a.send=function(a,f,d){"function"==typeof a.beforeSend&&a.beforeSend(a);switch(a.method.toLowerCase()){case "get":$.ajax({url:a.url,type:"GET",async:a.async,beforeSend:function(c){for(var b=0;b<a.headers.length;b+=1)c.setRequestHeader(a.headers[b].key,a.headers[b].value)},success:function(e){try{e=JSON.parse(e)}catch(m){}c(e,f,d);b.onResponse(e,a)},error:function(){b.onError(a)}});break;case "post":$.ajax({url:a.url,type:"POST",async:a.async,contentType:"application/json",
data:JSON.stringify(a.data),beforeSend:function(c){for(var b=0;b<a.headers.length;b+=1)c.setRequestHeader(a.headers[b].key,a.headers[b].value)},success:function(e){try{e=JSON.parse(e)}catch(m){}c(e,f,d);b.onResponse(e,a)},error:function(){b.onError(a)}});break;case "put":$.ajax({url:a.url,type:"PUT",contentType:"application/json",data:JSON.stringify(a.data),async:a.async,beforeSend:function(c){for(var b=0;b<a.headers.length;b+=1)c.setRequestHeader(a.headers[b].key,a.headers[b].value)},success:function(e){try{e=
JSON.parse(e)}catch(m){}c(e,f,d);b.onResponse(e,a)},error:function(){b.onError(a)}});break;case "delete":$.ajax({url:a.url,type:"DELETE",async:a.async,beforeSend:function(c){for(var b=0;b<a.headers.length;b+=1)c.setRequestHeader(a.headers[b].key,a.headers[b].value)},success:function(e){try{e=JSON.parse(e)}catch(m){}c(e,f,d);b.onResponse(e,a)},error:function(){b.onError(a)}});break;default:throw Error("Unrecognized http method: "+a.method);}};a.isOnline=function(){return window.navigator.onLine||!0};
var c=function(a,c,b){if(c.length!=b.length)throw Error("Callback length and state length mismatch!");for(var f=0;f<c.length;f+=1)c[f].apply({},[a,b[f]])},b=a;$=$||{};$.ajax=$.ajax||{};return a},a=function(){this.send=function(){}};global.Appacitive.http=new function(){var c=global.Appacitive.runtime.isBrowser?new b:new a,h=new d(c),e=!1;this.pause=function(){e=!0};this.unpause=function(){e=!1};this.addProcessor=function(a){var c=Error('Must provide a processor object with either a "pre" function or a "post" function.');
if(!a)throw c;if(!a.pre&&!a.post)throw c;h.addProcessor(a)};this.send=function(a){h.enqueueRequest(a);c.isOnline()&&!1==e&&h.notify()};this.flush=function(a){a?h.notify():c.isOnline()&&h.notify()};this.onError=function(a){if(a.onError)if(a.context)a.onError.apply(a.context,[]);else a.onError()};c.onError=this.onError;this.onResponse=function(a,c){if(c.onSuccess)if(c.context)c.onSuccess.apply(c.context,[a]);else c.onSuccess(a)};c.onResponse=this.onResponse};global.Appacitive.HttpRequest=function(){this.url=
"";this.data={};this.async=!0;this.headers=[];this.method="GET"};global.Appacitive&&global.Appacitive.http&&global.Appacitive.http.addProcessor({pre:function(){return(new Date).getTime()},post:function(a,c){var b=(new Date).getTime()-c;a._timeTakenInMilliseconds=b}});var c=global;c.Appacitive&&c.Appacitive.http&&c.Appacitive.http.addProcessor({pre:function(a){return a},post:function(a,b){c.Appacitive.session.isSessionValid(a)||(null!=c.Appacitive.session.get()&&(c.Appacitive.session.resetSession(),
c.Appacitive.session.onSessionCreated=function(){c.Appacitive.http.unpause();c.Appacitive.http.flush();c.Appacitive.session.onSessionCreated=function(){}},c.Appacitive.session.recreate(),c.Appacitive.http.pause()),c.Appacitive.http.send(b))}})})();
...
d.Appacitive.bag.selectedCatalog.Id:d.Appacitive.bag.selectedCatalog.BlueprintId,a)}};this.relation={relationServiceUrl:b+"/relationservice",getEntityId:function(){return"deployment"==d.Appacitive.bag.selectedType?d.Appacitive.bag.selectedCatalog.blueprintid:d.Appacitive.bag.selectedCatalog.id},getExportUrl:function(a){return"Relations.exp?ctype=Relation&blueprintid="+a},getSearchBySchemaUrl:function(a,c,b){var d="",d=String.format("{0}/{1}/find/{2}",this.relationServiceUrl,a,c),d=d+"?psize=200";
if("undefined"!==typeof b&&0<b.length)for(a=0;a<b.length;a+=1)d=d+"&"+b[a];return d},getSearchAllUrl:function(a,c){var b="";a&&(b=String.format("{0}/find/all/{1}",this.relationServiceUrl,a));b+="?psize=200";if("undefined"!==typeof c&&0<c.length)for(var d=0;d<c.length;d+=1)b=b+"&"+c[d];return b},getGetPropertiesUrl:function(a){return String.format("{0}/get/{1}/{2}/true",this.relationServiceUrl,this.getEntityId(),a)},getCreateUrl:function(){return String.format("{0}/create/{1}",this.relationServiceUrl,
...
a)},getDeletePropertyUrl:function(a,c){return String.format("{0}/deleteProperty/{1}/{2}/{3}",this.relationServiceUrl,this.getEntityId(),a,c)},getUpdatePropertyUrl:function(a){return String.format("{0}/updateProperty/{1}/{2}",this.relationServiceUrl,this.getEntityId(),a)},getUpdateEndPointUrl:function(a,c){return String.format("{0}/updateEndpoint/{1}/{2}/{3}",this.relationServiceUrl,this.getEntityId(),a,c)},getGetUrl:function(a){return String.format("{0}/get/{1}/{2}",this.relationServiceUrl,"blueprint"==
d.Appacitive.bag.selectedType?d.Appacitive.bag.selectedCatalog.Id:d.Appacitive.bag.selectedCatalog.BlueprintId,a)}};this.cannedList={cannedListServiceUrl:b+"/listservice",getEntityId:function(){return"deployment"==d.Appacitive.bag.selectedType?d.Appacitive.bag.selectedCatalog.blueprintid:d.Appacitive.bag.selectedCatalog.id},getExportUrl:function(a){return"CannedLists.exp?ctype=List&blueprintid="+a},getListItemExportUrl:function(a,c){return"CannedLists.exp?ctype=ListItems&blueprintid="+a+"&type="+
c},getSearchAllUrl:function(a,c){var b="";a&&(b=String.format("{0}/find/all/{1}",this.cannedListServiceUrl,a));b+="?psize=200";if("undefined"!==typeof c&&0<c.length)for(var d=0;d<c.length;d+=1)b=b+"&"+c[d];return b},getGetItemsUrl:function(a){return String.format("{0}/get/{1}/{2}",this.cannedListServiceUrl,this.getEntityId(),a)},getCreateUrl:function(){return String.format("{0}/create/{1}",this.cannedListServiceUrl,this.getEntityId())},getDeleteUrl:function(a){return String.format("{0}/delete/{1}/{2}",
this.cannedListServiceUrl,this.getEntityId(),a)},getSearchListItemsUrl:function(a,b){var d=String.format("{0}/searchListItems/{1}/{2}",this.cannedListServiceUrl,this.getEntityId(),a);if("undefined"!==typeof b&&0<b.length){for(var d=d+"?",h=0;h<b.length;h+=1)d=d+b[h]+"&";d=d.substring(0,d.length-1)}return d},getUpdateListItemPositionUrl:function(a,b,d){return String.format("{0}/updateListItemPosition/{1}/{2}/{3}/{4}",this.cannedListServiceUrl,this.getEntityId(),a,b,d)},getDeleteListItemUrl:function(a,
...
this.deploymentServiceUrl,"__Sandbox_"+d.Appacitive.bag.apps.selected.name,a)}};this.tag={tagServiceUrl:b+"/tagsservice",getEntityId:function(){return"deployment"==d.Appacitive.selectedType?d.Appacitive.bag.selectedCatalog.blueprintid:d.Appacitive.bag.selectedCatalog.id},getAddTagUrl:function(a,b,d,h){return String.format("{0}/addTag/{1}/{2}/{3}/{4}?tag={5}",this.tagServiceUrl,this.getEntityId(),a,b,d,h)},getRemoveTagUrl:function(a,b,d,h){return String.format("{0}/removeTag/{1}/{2}/{3}/{4}?tag={5}",
this.tagServiceUrl,this.getEntityId(),a,b,d,h)}};this.invoice={invoiceServiceUrl:b+"/invoiceservice",getUsageStatsUrl:function(){return this.invoiceServiceUrl+"/usage/"+d.Appacitive.bag.accountName}};this.account={accountServiceUrl:b+"/accountservice",getCreateNewAccountUrl:function(a){return String.format("{0}/createaccount?skipValid={1}",this.accountServiceUrl,a)},getAccountIdUrl:function(a){return this.accountServiceUrl+"/accountId/"+a},checkAccountNameUrl:function(a){return this.accountServiceUrl+
...
h){var e=h.split("="),j=e[1];2<e.length&&e.forEach(function(a){0==a||1==a||(j=j+"="+e[a])});e[0].toLowerCase()==a&&(b=[e[0],j])}),b):location.search.split("?")[1].split("=")}};this.announcement={announcementServiceUrl:b+"/announcementservice",getSummaryUrl:function(){return this.announcementServiceUrl+"/summary"}};this.graphite={graphiteBaseUrl:b+"/sessionservice/getGraph",getBaseUrl:function(){return this.graphiteBaseUrl}};this.emailtemplate={emailTemplateServiceUrl:b+"/emailservice",getCreateUrl:function(){return this.emailTemplateServiceUrl+
...
var h="sandbox";this.__defineGetter__("environment",function(){return h});this.__defineSetter__("environment",function(a){"sandbox"!=a&&"live"!=a&&(a="sandbox");h=a})}})(global);(function(d){d.Appacitive&&d.Appacitive.http&&d.Appacitive.http.addProcessor({pre:function(e){e.headers.push({key:"appacitive-environment",value:d.Appacitive.session.environment})}})})(global);
...
(function(d){d.Appacitive.BaseObject=function(e){_snapshot=null;var b=e=e||{};this.fetch=function(a,c){a=a||function(){};c=c||function(){};if(b.__id){var e=this,j=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory[this.type].getGetUrl(b.__schematype||b.__relationtype,b.__id),g=new d.Appacitive.HttpRequest;g.url=j;g.method="get";g.onSuccess=function(d){if(d&&d.article){_snapshot=d.article;b.__id=d.article.__id;for(var g in d.article)"undefined"==typeof b[g]&&(b[g]=d.article[g]);e.___collection&&
"article"==e.___collection.collectionType&&e.___collection.addToCollection(e);a()}else c()};d.Appacitive.http.send(g)}else c()};this.del=function(a,c,e){a=a||function(){};c=c||function(){};e=e||{};if(b.__id){var j=this,g=d.Appacitive.config.apiBaseUrl,g=g+d.Appacitive.storage.urlFactory[this.type].getDeleteUrl(b.__schematype||b.__relationtype,b.__id);b&&(b.__schematype&&"user"==b.__schematype.toLowerCase())&&(g=d.Appacitive.config.apiBaseUrl,g+=d.Appacitive.storage.urlFactory.user.getUserDeleteUrl(b.__id));
e.deleteConnections&&!0===e.deleteConnections&&(g=-1==g.indexOf("?")?g+"?deleteconnections=true":g+"&deleteconnections=true");e=new d.Appacitive.HttpRequest;e.url=g;e.method="delete";e.onSuccess=function(d){"200"==d.code?(j.___collection&&j.___collection.removeById(b.__id),a()):c()};e.beforeSend=function(a){console.log("DELETE: "+a.url)};d.Appacitive.http.send(e)}else this.___collection.removeByCId(this.__cid),a()};this.getArticle=function(){return b};this.attributes=function(){if(0===arguments.length)return b.__attributes||
...
throw Error(".aggregates() called with an incorrect number of arguments. 0, and 1 are supported.");};this.get=function(a){if(a)return b[a]};this.set=function(a,c){a&&(b[a]=c);return c};this.save=function(d,e){b.__id?a.apply(this,arguments):c.apply(this,arguments)};var a=function(a,c){var e=!1,j=JSON.parse(JSON.stringify(_snapshot)),g;for(g in b)"undefined"==typeof b[g]||null===b[g]?(j[g]=null,e=!0):b[g]!=_snapshot[g]?(j[g]=b[g],e=!0):b[g]==_snapshot[g]&&delete j[g];e&&(e=new d.Appacitive.HttpRequest,
...
b.__schematype.toLowerCase()&&(j=d.Appacitive.config.apiBaseUrl+d.Appacitive.storage.urlFactory.user.getCreateUserUrl());var g=new d.Appacitive.HttpRequest;g.url=j;g.method="put";g.data=b;g.onSuccess=function(d){var g=null;d&&(g=d.article||d.connection||d.user);if(d&&g){_snapshot=g;b.__id=g.__id;for(var j in g)"undefined"==typeof b[j]&&(b[j]=g[j]);e.connectionCollections&&0<e.connectionCollections.length&&e.connectionCollections.forEach(function(a){a.getQuery().extendOptions({articleId:b.__id})});
"function"==typeof a&&a()}else"function"==typeof c&&c()};d.Appacitive.http.send(g)}}})(global);
(function(d){var e=function(){return Math.floor(65536*Math.random()).toString(16)};d.Appacitive.GUID=function(){var b=e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e(),a="",c,d,h,k,j,g,l=0,b=b.replace(/\r\n/g,"\n");d="";for(h=0;h<b.length;h++)k=b.charCodeAt(h),128>k?d+=String.fromCharCode(k):(127<k&&2048>k?d+=String.fromCharCode(k>>6|192):(d+=String.fromCharCode(k>>12|224),d+=String.fromCharCode(k>>6&63|128)),d+=String.fromCharCode(k&63|128));for(b=d;l<b.length;)c=b.charCodeAt(l++),d=b.charCodeAt(l++),
h=b.charCodeAt(l++),k=c>>2,c=(c&3)<<4|d>>4,j=(d&15)<<2|h>>6,g=h&63,isNaN(d)?j=g=64:isNaN(h)&&(g=64),a=a+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(j)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g);return a.toString()}})(global);
(function(d){d.Appacitive.ArticleCollection=function(e){var b=null,a=null,c=[],f=e;this.collectionType="article";if(!e||!e.schema)throw Error("Must provide schema while initializing ArticleCollection.");var h=this,k=function(c){b=c.schema;c.type="article";a=new d.Appacitive.queries.SearchAllQuery(c);h.extendOptions=a.extendOptions;f=c};this.setFilter=function(c){f.filter=c;f.type="article";f.schema=b;a=new d.Appacitive.queries.BasicFilterQuery(e)};this.reset=function(){b=f=null;c.length=0;a=null};
this.getQuery=function(){return a};this.setOptions=k;k(e);this.get=function(a){if(a!=parseInt(a,10))return null;a=parseInt(a,10);return"number"!=typeof a||a>=c.length?null:c.slice(a,a+1)[0]};this.addToCollection=function(a){if(!a||a.get("__schematype")!=b)throw Error("Null article passed or schema type mismatch");var d=null;c.forEach(function(b,c){b.get("__id")==a.get("__id")&&(d=c)});0!=d?c.splice(d,1):c.push(a)};this.getArticle=function(a,b,d){b=b||function(){};d=d||function(){};var e=c.filter(function(b){return b.get("__id")==
a});1==e.length?b(Array.prototype.slice.call(e)[0]):d()};this.getAll=function(){return Array.prototype.slice.call(c)};this.removeById=function(a){if(!a)return!1;var b=null;c.forEach(function(c,d){c.getArticle().__id&&c.getArticle().__id==a&&(b=d)});return null!==b?(c.splice(b,1),!0):!1};this.removeByCId=function(a){if(!a)return!1;var b=null;c.forEach(function(c,d){c.__cid&&c.__cid==a&&(b=d)});return null!==b?(c.splice(b,1),!0):!1};this.fetch=function(b,e){b=b||function(){};e=e||function(){};c.length=
0;var f=a.toRequest();f.onSuccess=function(a){var f=b;if(a=a.articles){if(!a.length||0===a.length)a=[];a.forEach(function(a){a=new d.Appacitive.Article(a);a.___collection=h;c.push(a)});f()}else e()};d.Appacitive.http.send(f)};this.createNewArticle=function(a){a=a||{};a.__schematype=b;a=new d.Appacitive.Article(a);a.___collection=h;a.__cid=parseInt(1E6*Math.random(),10);c.push(a);return a};this.map=function(){return c.map.apply(this,arguments)};this.forEach=function(){return c.forEach.apply(this,arguments)};
this.filter=function(){return c.filter.apply(this,arguments)}}})(global);
(function(d){d.Appacitive.ConnectionCollection=function(e){var b=null,a=null,c=[],f=[],h=e;this.collectionType="connection";if(!e||!e.relation)throw Error("Must provide relation while initializing ConnectionCollection.");var k=function(c){b=c.relation;c.type="connection";a=new d.Appacitive.queries.SearchAllQuery(c);h=c};this.setFilter=function(c){h.filter=c;h.type="connection";h.relation=b;a=new d.Appacitive.queries.BasicFilterQuery(e)};this.setQuery=function(b){if(!b)throw Error("Invalid query passed to connectionCollection");
c.length=0;a=b};this.reset=function(){b=h=null;articles.length=0;c.length=0;a=null};this.getQuery=function(){return a};this.setOptions=k;k(e);this.get=function(a){if(a!=parseInt(a,10))return null;a=parseInt(a,10);return"number"!=typeof a||a>=c.length?null:c.slice(a,a+1)[0]};this.addToCollection=function(a){if(!a||a.get("__relationtype")!=b)throw Error("Null connection passed or relation type mismatch");var d=null;c.forEach(function(b,c){b.get("__id")==a.get("__id")&&(d=c)});null!==d?c.splice(d,1):
c.push(a)};this.getConnection=function(a,b,d){b=b||function(){};d=d||function(){};var e=c.filter(function(b){return b.get("__id")==a});1==e.length?b(Array.prototype.slice.call(e)[0]):d()};this.getAll=function(){return Array.prototype.slice.call(c)};this.removeById=function(a){if(!a)return!1;var b=null;c.forEach(function(c,d){c.getConnection().__id&&c.getConnection().__id==a&&(b=d)});return null!==b?(c.splice(b,1),!0):!1};this.removeByCId=function(a){if(!a)return!1;var b=null;c.forEach(function(c,
d){c.__cid&&c.__cid==a&&(b=d)});return null!==b?(c.splice(b,1),!0):!1};var j=this;this.getConnectedArticle=function(a){if(!f||0===f.length)return null;var b=f.filter(function(b){return b.get("__id")==a});return 0<b.length?b[0]:null};this.fetch=function(b,e){b=b||function(){};e=e||function(){};c.length=0;var h=a.toRequest();h.onSuccess=function(a){a:{var h=b;a=a||{};var k=a.connections;if(!k)if(a.status&&a.status.code&&"200"==a.status.code)k=[];else{e();break a}if(!k.length||0===k.length)k=[];k.forEach(function(a){var b=
new d.Appacitive.Connection(a);b.___collection=j;c.push(b);if(a.__endpointa.article||a.__endpointb.article)a=new d.Appacitive.Article(a.__endpointa.article||a.__endpointb.article),a.___collection=j,f.push(a)});h()}};d.Appacitive.http.send(h)};this.createNewConnection=function(a){a=a||{};a.__relationtype=b;a=new d.Appacitive.Connection(a);a.___collection=j;a.__cid=parseInt(1E6*Math.random(),10);c.push(a);return a};this.map=function(){return c.map.apply(this,arguments)};this.forEach=function(a,b){return c.forEach(a,
